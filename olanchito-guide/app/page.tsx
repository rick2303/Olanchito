    ...
    <main className="min-h-screen flex flex-col font-sans bg-jungle-50">
      ...
      <section className="relative bg-gradient-to-br from-jungle-400 to-jungle-700 text-jungle-50 px-6 py-32 text-center overflow-hidden">
        ...
        <h1 className="text-4xl sm:text-5xl font-extrabold mb-6 leading-tight drop-shadow-lg">
          Todo <span className="text-jungle-50">Olanchito</span>, en un solo lugar
        </h1>

        <p className="text-lg sm:text-xl text-jungle-100 mb-12 max-w-2xl mx-auto drop-shadow-md">
          El directorio local donde encuentras negocios reales, servicios confiables y contacto directo.
        </p>

        <div className="flex flex-col sm:flex-row justify-center gap-4 mb-8">
          <Link
            href="/businesses"
            className="bg-white text-jungle-700 px-8 py-4 rounded-xl font-semibold shadow-lg hover:scale-105 hover:shadow-2xl transition"
          >
            Ver negocios
          </Link>
          ...
          <Link
            href="/categories"
            className="border border-white/50 px-8 py-4 rounded-xl font-medium hover:bg-white/20 transition"
          >
            Ver categorías
          </Link>
        </div>
