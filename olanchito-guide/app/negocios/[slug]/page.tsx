      ...
      <section className="mx-auto max-w-5xl px-4 pb-12 pt-8 sm:px-6 lg:pt-10">
        <div className="grid gap-8 lg:grid-cols-[1.4fr_0.9fr]">
          ...
          <aside className="space-y-6">
            ...
            {(ig || fb || web) && (
              <div className="rounded-3xl bg-white p-6 ring-1 ring-black/5 shadow-[0_10px_30px_rgba(0,0,0,0.06)] sm:p-7">
                <h3 className="text-base font-bold text-jungle-950">Enlaces</h3>
                ...
                <div className="mt-4 grid gap-2">
                  {ig ? (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex items-center justify-between rounded-2xl bg-white px-4 py-3 text-sm font-semibold text-jungle-950 ring-1 ring-black/10 hover:bg-jungle-50"
                    >
